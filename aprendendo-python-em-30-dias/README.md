# 🐍 Python para Área de Dados | Prática 30 dias 
...
🔊 Mas Atenção: o aprendizado depende da sua dedicação e prática, o objetivo aqui é praticar um script por dia, ler seu tutorial que todos terão como comentário, e reforçar com os [Recursos Extras](#-recursos-extras). 
...
- [Aprenda Python jogando](https://www.codedex.io/python)
...
Caso tenha alguma sugestão, feedback ou queira falar comigo. Vamos nos conectar no linkedin👇
...
- [Mais Recursos](https://topmate.io/fabiomarcolia)
